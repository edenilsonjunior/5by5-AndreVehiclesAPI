...
{
    public static readonly string POST = "INSERT INTO CarFinancing (SaleId, FinancingDate, BankCnpj) VALUES (@SaleId, @FinancingDate, @BankCnpj); SELECT CAST(SCOPE_IDENTITY() as int)";
