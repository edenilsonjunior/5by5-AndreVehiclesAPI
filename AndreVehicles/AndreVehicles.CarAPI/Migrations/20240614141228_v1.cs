        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customer_Person_Document",
                        column: x => x.Document,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarPlate = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MainDriverDocument = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Insurance_Driver_MainDriverDocument",
                        column: x => x.MainDriverDocument,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Insurance_MainDriverDocument",
                table: "Insurance",
                column: "MainDriverDocument");
